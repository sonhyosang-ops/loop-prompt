...
(function () {
  'use strict';
  var DOCS = [
    { path: 'concepts/Concepts_Chapter.html',   title: '개념과 원리' },
    { path: 'tools/Tools_Manual.html',           title: 'Claude Code 루프 도구 레퍼런스' },
    { path: 'tools/Tools_Examples.html',         title: 'Claude Code 루프 도구 실습 예시' },
    { path: 'patterns/Patterns_Manual.html',     title: '루프 설계 패턴 레퍼런스' },
    { path: 'patterns/Patterns_Examples.html',   title: '루프 설계 패턴 실습 예시' },
    { path: 'quiz/Quiz_Quiz.html',               title: '학습 확인 문제 풀이' }
  ];
